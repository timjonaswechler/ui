...
fn setup(mut commands: Commands) {
    ...
    commands
        ...
        .with_children(|parent| {
            ...
            parent.spawn(Text::title("Checkbox Sizes").size(TextSize::Xl).build());
            ...
            parent
                ...
                .with_children(|row| {
                    ...
                    .with_children(|col| {
                        ...
                        col.spawn(Text::body("Size 1 (16px)").size(TextSize::Sm).build());
                    });
                    ...
                    .with_children(|col| {
                        ...
                        col.spawn(Text::body("Size 2 (20px)").size(TextSize::Sm).build());
                    });
                    ...
                    .with_children(|col| {
                        ...
                        col.spawn(Text::body("Size 3 (24px)").size(TextSize::Sm).build());
                    });
                });
            ...
            parent.spawn(Text::title("Checkbox States").size(TextSize::Xl).build());
            ...
            parent
                ...
                .with_children(|col| {
                    ...
                    .with_children(|row| {
                        ...
                        row.spawn(Text::body("Unchecked - Click to toggle").build());
                    });
                    ...
                    .with_children(|row| {
                        ...
                        row.spawn(Text::body("Initially checked - Click to toggle").build());
                    });
                    ...
                    .with_children(|row| {
                        ...
                        row.spawn(Text::body("Disabled (unchecked)").build());
                    });
                    ...
                    .with_children(|row| {
                        ...
                        row.spawn(Text::body("Disabled (checked)").build());
                    });
                });

            // Section spacing
            parent.spawn(BoxComponent::new("spacing-3").height(Val::Px(32.0)).build());

            // Form Example Section
            parent.spawn(Text::title("Form Example").size(TextSize::Xl).build());
            ...
            parent
                ...
                .with_children(|form| {
                    form.spawn(Text::title("Settings").size(TextSize::Lg).build());
            ...
            // Section spacing
            parent.spawn(BoxComponent::new("spacing-4").height(Val::Px(32.0)).build());

            // Color Variants Section
            parent.spawn(Text::title("Color Variants").size(TextSize::Xl).build());
            ...
            parent
                ...
                .with_children(|row| {
                    ...
                    .with_children(|col| {
                        col.spawn(Checkbox::checked("accent-checkbox").accent().build());
                        col.spawn(Text::body("Accent").size(TextSize::Sm).build());
                    });
            ...
            // Instructions
            parent.spawn(BoxComponent::new("spacing-5").height(Val::Px(32.0)).build());

            parent.spawn(
                Text::body(
                    "Click any checkbox to toggle its state. Check the console for change events.",
                )
                .size(TextSize::Sm)
                .build(),
            );
