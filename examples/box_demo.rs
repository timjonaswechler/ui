...
use ui::{
    ...
    theme::{color::{blue_palette, green_palette, red_palette}, typography::TextSize},
            ...
            parent
                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            parent.spawn(
                                Text::body("Panel Box - Prominent background with blue theme")
                                    .build(),
                            );
                        });
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            parent.spawn(
                                Text::body("Outline Box - Border only with red theme").build(),
                            );
                        });
